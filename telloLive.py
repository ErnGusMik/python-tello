...
while True:
    try:
        ...
        # Help functionality (when typed 'help')
            ...
            print('     curve x1 y1 z1 x2 y2 z2 s -- Fly at a curve (make corner from coordinates) at s speed (arc radius must be between 0.5m and 10m)')
            ...
            print('     curve x1 y1 z1 x2 y2 z2 s mid -- Fly at a curve (make corner from coordinates) at s speed (arc radius must be between 0.5m and 10m) of the mission pad')
            print('                   x1, x2 = left, right (-500 to 500)')
            print('                   y1, y2 = forwards, backwards (-500 to 500)')
            print('                   z1, z2 = up, down (-500 to 500)')
            print('                   s = cm/s (10 to 60)')
            print('     jump x y z s yaw mid1 mid2 -- Fly to x, y, z of mid1 and recognize 0, 0, z of mid2 and rotate yaw')
            print('                   x = left, right (-500 to 500)')
            print('                   y = forwards, backwards (-500 to 500)')
            print('                   z = up, down (-500 to 500)')
            print('                   s = cm/s (10 to 100)')
            ...
            print('     mdirection x -- Sets mission pad detection to x: either downward (0), forward (1), or both (2)')
            print('\r\nTo view set, read and hard functions, type \'help set\', \'help read\' or \'help hard\' \r\n\r\n')
        elif msg == 'help read':
            print('\r\nRead commands:')
